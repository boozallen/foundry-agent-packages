...
def test_bound_constants_reexported_from_package_root():
    """Package-root re-export resolves to the same object as types.py."""
    ...
    from foundry_agent_core import types as types_module

    assert _MAX_QUERY_LEN is types_module._MAX_QUERY_LEN
    assert _MAX_DICT_BYTES is types_module._MAX_DICT_BYTES
    assert _MAX_DICT_KEYS is types_module._MAX_DICT_KEYS
    assert _MAX_DICT_KEY_LEN is types_module._MAX_DICT_KEY_LEN
    assert _MAX_CONTENT_LEN is types_module._MAX_CONTENT_LEN
    assert _MAX_RESULTS is types_module._MAX_RESULTS
