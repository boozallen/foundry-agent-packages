...
class TestAC3ToolLoaderFrozen:
    ...
    def test_tool_loader_diff_only_imports(self):
        # tests/unit/<this file> -> package root at parents[2]
        original = Path(__file__).parents[6] / "strands-base-agent/strands_base_agent/agent/tool_loader.py"
        extracted = Path(__file__).parents[2] / "src/foundry_strands_agent/tool_loader.py"
